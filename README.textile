...
@curl -L https://github.com/millisami/oh-my-zsh/raw/master/tools/install.sh | sh@

h4. via `wget`

>>>>>>> readme, zshrc template and install.sh modified to use my own fork
@wget --no-check-certificate https://github.com/millisami/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/millisami/oh-my-zsh.git ~/.oh-my-zsh@
