...
# Gist from: https://raw.githubusercontent.com/frosenberg/docker-dns-scripts/master/enable-docker-dns.sh
...
echo "\n   Add export DOCKER_HOST=\"tcp://$(boot2docker ip):2375\" to your .bash_profile if you haven't already ..."
